...
| Devil | deliberately trade safety for aggression | surviving damage opens one visible bargain window | thrown, melee, aggressive, curse | survivability debt | Devil's Bargain now converts a hit into bounded melee/thrown offense while surrendering real armor instead of copying Demon Lord kill stacks |
