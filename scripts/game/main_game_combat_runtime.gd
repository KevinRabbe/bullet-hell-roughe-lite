...
static func clear_combat_entities(owner: Node) -> void:
	RunFlowRuntime.clear_group_nodes(owner.get_tree(), "enemies")
	RunFlowRuntime.clear_group_nodes(owner.get_tree(), "projectiles")
