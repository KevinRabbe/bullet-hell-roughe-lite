...
const ShopOfferResolver = preload("res://scripts/game/shop_offer_resolver.gd")
...
var offer_resolver := ShopOfferResolver.new()

func _ready() -> void:
	rng = _resolve_rng("shop")
	offer_resolver.configure(rng)
...
func _build_weapon_offer_pool() -> void:
	_weapon_offer_pool = offer_resolver.build_weapon_offer_pool(get_node_or_null("/root/DataRegistry"))

func _build_item_offer_pool() -> void:
	_item_offer_pool = offer_resolver.build_item_offer_pool()
...
func _roll_offers() -> void:
	active_offers = offer_resolver.roll_offers(
		_weapon_offer_pool,
		_item_offer_pool,
		_current_wave_index,
...
func _on_offer_pressed(index: int) -> void:
	...
	active_offers[index] = offer_resolver.sold_out_offer()
	_refresh_offer_buttons()
